...
export default function Navbar(){
    return(
        <>
            <nav className="w-[1650px] h-[100px] mx-auto bg-[#1D2239] px-[50px] flex flex-row justify-between items-center mobileS:hidden mobileM:hidden mobileL:hidden tablet:hidden">
          <div>

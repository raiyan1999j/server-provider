...
export default function AllService({modalCondition}) {
  ...
  return (
    <>
      <section className={`w-[1050px] mx-auto bg-[#1D2239] rounded-lg mt-20 py-8 px-8 transition-opacity duration-150 ease-linear ${modalEffect?"opacity-100":"opacity-0"} mobileS:w-[320px] mobileS:px-0`}>
        <div className="w-[986px] mx-auto flex flex-row items-center justify-between mobileS:w-[320px] mobileS:flex-col mobileS:gap-y-4">
          <div>
        ...
        <div className="w-[986px] mx-auto grid grid-cols-[repeat(3,_318px)] gap-x-4 gap-y-4 mt-8 mobileS:w-[320px] mobileS:grid-cols-1 mobileS:px-4">
        ...
        <div className="w-[986px] mx-auto mt-12 text-right mobileS:w-[320px] mobileS:text-center mobileS:mb-20">
